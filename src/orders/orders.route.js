...
const app = express();
app.use(cors({ origin: "https://chi-matcha.com" }));
...
router.post("/create-checkout-session", async (req, res) => {
  ...
  try {
    ...
    const data = {
      ...
      mode: "payment",
      products: lineItems,
      success_url: "https://chi-matcha.com/SuccessRedirect?client_reference_id=" + nowId,
      cancel_url: "https://chi-matcha.com/cancel",
      metadata: {
